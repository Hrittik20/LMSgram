            ...
            return (
              ...
              >
                <div className="card-header">
                  <div className={`card-icon ${isOverdue ? 'card-icon-danger' : daysUntilDue <= 2 ? 'card-icon-warning' : 'card-icon-primary'}`}>
                    📝
                  </div>
                  <div className="card-body">
                    ...
                    {assignment.due_date && (
                      <div className={`card-meta ${isOverdue ? 'text-danger' : daysUntilDue <= 2 ? 'text-warning' : ''}`}>
                        ⏰ {isOverdue 
                          ? 'Overdue' 
                          : daysUntilDue === 0 
                          ? 'Due today' 
                        ...
                        {isOverdue && <span className="badge badge-danger ml-sm">Late</span>}
                        {!isOverdue && daysUntilDue <= 2 && <span className="badge badge-warning ml-sm">Soon</span>}
                      </div>
                    )}
                  </div>
